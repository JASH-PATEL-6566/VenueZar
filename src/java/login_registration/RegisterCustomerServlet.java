    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if(!password.equals(con_password)){
            ...
            try {
                ...
                if (rowsInserted > 0) {
                    response.sendRedirect("LoginForCustomer.html");
                } else {
                    try {
                        String res = AlertMessage.alertMessage("Registration Of Customer Is Faild....... Please try again.","RegisterForCustomer.html");
                        out.print(res);
                    } catch (NoSuchAlgorithmException ex) {
                        Logger.getLogger(RegisterOwnerServlet.class.getName()).log(Level.SEVERE, null, ex);
                    }
